                            ...
                            <div class="card-body p-5">
                                ...
                                <form action="{{ url('reset-password-update') }}" method="post">
                                    ...
                                    <div class="d-flex justify-content-center">
                                        <input type="submit" value="Reset Passord" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">
                                    </div>
                                    ...
                                    <p class="text-center text-muted mt-5 mb-0">Forgot Password?<a
                                            href="{{ url('forgot-password') }}" class="fw-bold text-body"><u>Reset
                                                </u></a>
                                           </p>
